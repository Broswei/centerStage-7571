...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public void setMotorVelocities(int v){
        leftFront.setVelocity(0.73*v);
        rightRear.setVelocity(v);
        leftRear.setVelocity(v);
        rightFront.setVelocity(0.73*v);
    }
    ...
    public String getPowers(){
        return this.leftFront.getPower() + ", " + this.leftRear.getPower() + ", " + this.rightRear.getPower() + ", " + this.rightFront.getPower();
    }
}
